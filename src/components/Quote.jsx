      ...
      <div className="quote-inner">
        ...
        <div className="quote-content">
          ...
          <blockquote className="quote-text">
            We started Business Cradle with one goal — to prove that world-class software can be built right here in Jabalpur. Every project we take on is a statement that geography does not limit greatness.
          </blockquote>
          <div className="quote-author">
            ...
            <div className="quote-author-info">
              ...
              <div className="quote-author-role">Founder &amp; CEO, Business Cradle</div>
            </div>
            <div className="quote-divider"></div>
            <div className="quote-company">
              <div className="quote-company-name">Business Cradle</div>
