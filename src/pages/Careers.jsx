    ...
    <div className="careers-page">
      ...
      <nav className="careers-nav">
        <a href="/" className="careers-logo">
          ...
          <div>
            <div className="careers-logo-name">Business <span>Cradle</span></div>
      ...
      <section className="careers-perks">
        <div className="careers-inner">
          <h2 className="careers-section-title">Why Join <em>Cradle?</em></h2>
            ...
            {openRoles.map(r => (
              <div className="role-card" key={r.title}>
                ...
                <div className="role-card-right">
                  <a
                    href={`https://wa.me/918962900701?text=Hi! I am interested in the ${r.title} position at Business Cradle.`}
                    target="_blank"
                    rel="noreferrer"
        ...
        <div className="careers-inner">
          <div className="careers-contact-card">
            ...
            <div className="careers-contact-right">
              ...
              <a href="https://wa.me/918962900701?text=Hi! I would like to join the Business Cradle team." target="_blank" rel="noreferrer" className="careers-wa-btn">
      ...
      <footer className="careers-footer">
        <div className="careers-inner">
          <span>© 2025 Business Cradle Technology Pvt. Ltd.</span>
